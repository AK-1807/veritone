...
const ImageTextCarousel = ({
    ...
    return (
        <div className={`sliderCard mx-[20px]`}>
...
export default function TwitterSlider({ data }) {
    ...
    return (
        <section className="testimonialSlider overflow-hidden">
            <div className={`max-w-[1550px] px-[20px] mx-auto`}>
                <div className="intro flex items-end justify-between mb-[42px]">
                    <div className="titleWrap w-[30%]">
                        <h2 className="h1 pb-[10px]">
                            Latest updates
                        </h2>
                    </div>
                    <div className="btnWrapper w-[38%] flex justify-between items-center">
