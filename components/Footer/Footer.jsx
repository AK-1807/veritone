...
const Footer = () => {
	...
	return (
		<footer className={`${styles.footer} py-[120px]`}>
			<div className="container">
				<div className="logo-outer w-full mb-[25px] h-[30px] relative">
				...
				<div className="wrapper w-full relative flex flex-wrap justify-between mb-[70px]">
					<div className="item-small lg:h-[180px] lg:mb-[50px] max-w-[198px] h-[226px] flex flex-wrap flex-col justify-between">
						...
						<div className="link-wrap">
							<span className="text-[15px] font-bold uppercase mb-[10px] inline-block">
								For developers
							</span>
							<Link
								href="/"
					...
					<div className="item-big  w-[50%] lg:w-full lg:ml-[-20px] laptop:w-[65%] flex flex-wrap sm:justify-start  justify-end ml-[-60px]">
						{Footerdata.map((wrap, index) => (
							<ul
								className={`col-three w-[calc(33.33%-120px)] lg:w-[calc(33.33%-40px)] sm:w-[calc(50%-40px)] sm:mb-[20px] lg:mx-[20px] mx-[60px] ${
									index === Footerdata.length - 1 ? 'mr-0' : ''
								}`}
								key={index}
							>
				...
				<div className="social-wrapper  relative before:content-[''] before:absolute before:top-[-20px] before:left-0 before:w-full before:h-[2px] before:bg-[#212121]">
					<div className="wrapper w-full flex flex-wrap  justify-between mb-[20px]">
						<ul className="link-wrap flex flex-wrap md:max-w-[70%] sm:hidden md:mx-auto md:mb-[30px] md:w-full justify-between ">
							<li>
								<Link
									className="text-[16px] font-normal underline text-[#212121] mr-[40px] lg:mr-[25px]  hover:text-purple transition-all duration-300 ease-in-out"
									href="/"
								>
									Terms
								</Link>
						...
						<div className="social-wrap md:w-[60%] sm:w-full sm:mb-[40px] flex flex-wrap md:mx-auto md:mb-[30px] justify-between w-[25%] lg:w-[30%]">
							<Link href="">
								<svg
									width="24"
									height="24"
					...
					<p className="small md:text-center sm:text-center">
						© Veritone, Inc. All rights reserved.
					</p>
				</div>
			</div>
		</footer>
